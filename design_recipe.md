...
social network, information, user_account, email_address, username, timeline, posts, post_title, post_content, post_views
```
...
| post                  | post_title, post_contents, post_views
...
2. Name of the second table (always plural): `posts` 
    ...
    Column names: `post_title`, `post_contents`, `post_views`
